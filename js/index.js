...
let fruitsJSON = `[
  {"kind": "Mangosteen", "color": "violet", "weight": 13},
  {"kind": "Durian", "color": "green", "weight": 35},
  {"kind": "Lychee", "color": "carmazin", "weight": 17},
  {"kind": "Carambola", "color": "yellow", "weight": 28},
  {"kind": "Tamarind", "color": "lightbrown", "weight": 22}
]`;
...
const classArray = [{
    "fruit_violet": "violet",
    "fruit_green": "green",
    "fruit_carmazin": "carmazin",
    "fruit_yellow": "yellow",
    "fruit_lightbrown": "lightbrown"
}];
...
shuffleButton.addEventListener('click', () => {
  ...
  shuffleFruits();
  if (temp === JSON.stringify(fruits)) alert('The order has not changed!');
  display();
});
...
const shuffleFruits = () => {
  ...
  if (JSON.stringify(fruits) === JSON.stringify(result)) {
    alert('The order of the elements has not changed!')
  } else {
    fruits = result;
  }
};
...
addActionButton.addEventListener('click', () => {
  ...
  if (kindInput.value == 0 || colorInput.value == 0 || weightInput.value == 0) {
    alert('One of the fields is not filled in when adding a new element!');
  }
  else {
